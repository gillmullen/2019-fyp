...
/* Section 4: Grammar */
  ...
  static final public void function() throws ParseException {
    ...
    try {
      ...
      retType = type();
      id = lhs_identifier();
                                                  if(retType.equals("int")) { retType = "integer"; } st.insert(scope, id, retType, "FUNC"); scope = id;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x800000,0x400000,0x60000,0x29e000,0x2000,0x29c000,0x0,0x60000,0x60000,0x1c000,0x0,0x0,0xf0000000,0xf0000000,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x1a000,0x8000,0x0,0x0,0xfc0,0x1a000,0x0,0x0,0x1000,0x1000,0x0,0x0,0x6,0x6,0xfc0,};
   }
