...
public class IrCodeVisitor implements HOPEFULVisitor {
   ...
   public Object visit(ASTdeclaration node, Object data) {
      ...
      try {
         ...
         if(node.jjtGetNumChildren() == 3) {
            String expr = (String) node.jjtGetChild(2).jjtAccept(this, data);
            String tmp, var;
            DeclaredStrings s;
            int length;
            ...
            if(mty.equals("i8*")) {
               ...
               command = "store " + mty + " " + expr + ", " + mty + "* %.p." + id;
            }
