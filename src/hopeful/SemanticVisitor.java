...
public class SemanticVisitor implements HOPEFULVisitor {
   ...
   public Object visit (ASTdeclaration node, Object data) {
      if(node.jjtGetNumChildren() == 3) {
         ...
         SimpleNode child1 = (SimpleNode) node.jjtGetChild(0);
         String type1 = (String) child1.value;
         if(type1.equals("int")) {
            type1 = "integer";
         }
         ...
         if(!type1.equals(type2)) {
            correctAssignmentType = false;
            System.out.println("Fail: Variable Type " + type1 + " Assigned " + type2 + " Value!");
            System.out.println(id + " Assigned " + child2.value + " " + node.jjtGetChild(2).jjtGetChild(0));
         }
